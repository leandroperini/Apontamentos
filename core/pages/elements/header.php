...
<head>
    ...
    <script src="/assets/gentelella-master/production/assets/js/ie8-responsive-file-warning.js"></script>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="principal/home/" class="site_title"><i class="fa fa-paw"></i> <span>SGA!</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="/assets/gentelella-master/production/images/user.png" alt="..." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li>
                    <a><i class="fa fa-book"></i> Relatórios <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="reports/apontamentos_report">Relatório 1</a>
                    </li>
                    <li><a href="reports/apontamentos_report">Relatório 2</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-user"></i> Usuários <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="login/cadastrar">Cadastrar usuário</a>
                    </li>
                    <li><a href="login/usuarios">Consultar usuário</a>
                    </li>
                  </ul>
                </li>
                <li>
                    <a href="permission"><i class="fa fa-edit"></i> Permissões </a>
                </li>
                <li>
                    <a href=""><i class="fa fa-table"></i> Sobre </a>
                </li>
                <li>
